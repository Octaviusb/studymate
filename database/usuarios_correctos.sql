-- Usuarios correctos según login.html
...
-- Insertar usuarios correctos con hash de contraseña "123456"
INSERT INTO users (organization_id, username, email, password_hash, full_name, role, grade_level, status) VALUES
-- Super Admin
(1, 'admin', 'admin@studymate.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Super Administrador', 'super_admin', NULL, 'active'),
